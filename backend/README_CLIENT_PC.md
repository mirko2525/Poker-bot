...
🎯 Backend: https://table-analyzer.preview.emergentagent.com/api
...
- Apri nel browser: https://table-analyzer.preview.emergentagent.com/api/
...
```powershell
# Test API backend
curl https://table-analyzer.preview.emergentagent.com/api/
...
```
https://table-analyzer.preview.emergentagent.com/api/table/1/screenshot
https://table-analyzer.preview.emergentagent.com/api/table/1/screenshot?debug=true
```
